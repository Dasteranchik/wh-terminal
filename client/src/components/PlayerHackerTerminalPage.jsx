...
const PlayerHackerTerminalPage = () => {
    ...
    return(
        <div>
            ...
            <text> Необходимо подобрать слово-пароль из {command.password.length} букв методом перебора. Система  сообщает в ответ, сколько цифр угадано без совпадения с их позициями в пароле (то есть количество коров) и сколько угадано вплоть до позиции в пароле (то есть количество быков). Количество попыток не ограничено. Для возврата введите команду 'назад'</text><br/>
            Введите пароль
            <MyInput
            name = "password"
